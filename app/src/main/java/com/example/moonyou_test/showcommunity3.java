...
public class showcommunity3 extends AppCompatActivity{
    //객체 선언
    EditText comment_text;
    String BoardID, show_id, Boartype;
    int comments_value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show_id = intent.getStringExtra("showID");
        Boartype = intent.getStringExtra("Boartype");
    ...
    public void onBackPressed() {
        ...
        outIntent.putExtra("Boartype", Boartype);
        setResult(RESULT_OK, outIntent);
        finish();
    }
        ...
        db.collection("show_info")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        adapter = new commentsadpter(commentslist, showcommunity3.this);
